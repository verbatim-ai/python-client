...
class TestWidgetPost(unittest.TestCase):
    """WidgetPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WidgetPost:
        """Test WidgetPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WidgetPost`
        """
        model = WidgetPost()
        if include_optional:
            return WidgetPost(
