...
class TestDocumentDownloadUrl(unittest.TestCase):
    """DocumentDownloadUrl unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentDownloadUrl:
        """Test DocumentDownloadUrl
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentDownloadUrl`
        """
        model = DocumentDownloadUrl()
        if include_optional:
            return DocumentDownloadUrl(
                download_url = 'https://s3.fr-par.scw.cloud/bucket/documents/<corpus>/src/<doc>?X-Amz-Algorithm=...',
    ...
    def testDocumentDownloadUrl(self):
        """Test DocumentDownloadUrl"""
