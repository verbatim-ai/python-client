...
class TestUsageBucket(unittest.TestCase):
    """UsageBucket unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsageBucket:
        """Test UsageBucket
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsageBucket`
        """
        model = UsageBucket()
        if include_optional:
            return UsageBucket(
                ...
                tokens = 410,
                corpora = verbatim_client.models.usage_delta.UsageDelta(
                    created = 3, 
                    removed = 0, ),
                sessions = verbatim_client.models.usage_delta.UsageDelta(
                    created = 3, 
                    removed = 0, ),
                posts = verbatim_client.models.usage_delta.UsageDelta(
                    created = 3, 
                    removed = 0, ),
                storage = verbatim_client.models.usage_delta.UsageDelta(
                    created = 3, 
                    removed = 0, )
            )
        else:
