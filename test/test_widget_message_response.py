...
class TestWidgetMessageResponse(unittest.TestCase):
    """WidgetMessageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WidgetMessageResponse:
        """Test WidgetMessageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WidgetMessageResponse`
        """
        model = WidgetMessageResponse()
        if include_optional:
            return WidgetMessageResponse(
                data = verbatim_client.models.widget_message_response_item.WidgetMessageResponseItem(
                    input = verbatim_client.models.widget_session_request_body.WidgetSessionRequestBody(
                        text = '', 
                        session_uuid = '', ), 
                    output = verbatim_client.models.widget_session_request_body.WidgetSessionRequestBody(
                        text = '', 
                        session_uuid = '', ), 
                    session_uuid = '', )
            )
    ...
    def testWidgetMessageResponse(self):
        """Test WidgetMessageResponse"""
