...
class TestWidgetSessionResponseLegacy(unittest.TestCase):
    """WidgetSessionResponseLegacy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WidgetSessionResponseLegacy:
        """Test WidgetSessionResponseLegacy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WidgetSessionResponseLegacy`
        """
        model = WidgetSessionResponseLegacy()
        if include_optional:
            return WidgetSessionResponseLegacy(
                data = verbatim_client.models.widget_session_response_item.WidgetSessionResponseItem(
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    messages = [
                        verbatim_client.models.session_message.SessionMessage(
                            id = '', 
                            text = '', 
                            type = '', 
    ...
    def testWidgetSessionResponseLegacy(self):
        """Test WidgetSessionResponseLegacy"""
