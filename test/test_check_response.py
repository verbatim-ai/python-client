    ...
    def make_instance(self, include_optional) -> CheckResponse:
        ...
        if include_optional:
            return CheckResponse(
                status = 'UP',
                message = 'S3: SdkClientException: Unable to execute HTTP request: Connect timed out',
                checks = [
                    verbatim_client.models.check_item.CheckItem(
                        name = 'S3', 
                        status = 'UP', 
                        duration_ms = 42, 
                        error = 'SdkClientException: Unable to execute HTTP request: Connect timed out', )
                    ]
            )
        else:
            return CheckResponse(
