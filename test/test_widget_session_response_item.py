...
class TestWidgetSessionResponseItem(unittest.TestCase):
    """WidgetSessionResponseItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WidgetSessionResponseItem:
        """Test WidgetSessionResponseItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WidgetSessionResponseItem`
        """
        model = WidgetSessionResponseItem()
        if include_optional:
            return WidgetSessionResponseItem(
    ...
    def testWidgetSessionResponseItem(self):
        """Test WidgetSessionResponseItem"""
