...
class TestWidgetAttachment(unittest.TestCase):
    """WidgetAttachment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WidgetAttachment:
        """Test WidgetAttachment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WidgetAttachment`
        """
        model = WidgetAttachment()
        if include_optional:
