...
class TestWidgetMessageResponseItem(unittest.TestCase):
    """WidgetMessageResponseItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WidgetMessageResponseItem:
        """Test WidgetMessageResponseItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WidgetMessageResponseItem`
        """
        model = WidgetMessageResponseItem()
        if include_optional:
            return WidgetMessageResponseItem(
    ...
    def testWidgetMessageResponseItem(self):
        """Test WidgetMessageResponseItem"""
