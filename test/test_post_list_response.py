...
class TestPostListResponse(unittest.TestCase):
    """PostListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostListResponse:
        """Test PostListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostListResponse`
        """
