...
class TestWidgetSessionResponse(unittest.TestCase):
    """WidgetSessionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WidgetSessionResponse:
        """Test WidgetSessionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WidgetSessionResponse`
        """
        model = WidgetSessionResponse()
        if include_optional:
    ...
    def testWidgetSessionResponse(self):
        """Test WidgetSessionResponse"""
