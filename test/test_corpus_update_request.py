...
class TestCorpusUpdateRequest(unittest.TestCase):
    """CorpusUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CorpusUpdateRequest:
        """Test CorpusUpdateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CorpusUpdateRequest`
        """
        model = CorpusUpdateRequest()
        if include_optional:
            return CorpusUpdateRequest(
    ...
    def testCorpusUpdateRequest(self):
        """Test CorpusUpdateRequest"""
