...
class TestAccessTokenCreateRequest(unittest.TestCase):
    """AccessTokenCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessTokenCreateRequest:
        """Test AccessTokenCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessTokenCreateRequest`
        """
        model = AccessTokenCreateRequest()
        if include_optional:
    ...
    def testAccessTokenCreateRequest(self):
        """Test AccessTokenCreateRequest"""
