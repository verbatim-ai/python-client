...
class TestUsageDelta(unittest.TestCase):
    """UsageDelta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsageDelta:
        """Test UsageDelta
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsageDelta`
        """
        model = UsageDelta()
        if include_optional:
            return UsageDelta(
