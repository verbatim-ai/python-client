    ...
    def make_instance(self, include_optional) -> DocumentUpdateRequest:
        ...
        if include_optional:
            return DocumentUpdateRequest(
                filename = 'annual-report-2025-final.pdf',
                doc_create = '2026-01-15T10:30:00Z',
                doc_update = '2026-04-01T08:00:00Z',
                metadata = {source=user, team=legal, review=2026-Q3},
                tags = [legal, 2026, reviewed],
                chunk = {strategy=basic, max_characters=4000, overlap=200, overlap_all=true}
            )
        else:
            return DocumentUpdateRequest(
        )
