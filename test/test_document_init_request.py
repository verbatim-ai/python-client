...
class TestDocumentInitRequest(unittest.TestCase):
    """DocumentInitRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentInitRequest:
        """Test DocumentInitRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentInitRequest`
        """
        model = DocumentInitRequest()
        if include_optional:
            return DocumentInitRequest(
                corpus_id = '',
                filename = '',
                content_type = '',
                lang = '',
    ...
    def testDocumentInitRequest(self):
        """Test DocumentInitRequest"""
