...
class TestUserOnboardResponse(unittest.TestCase):
    """UserOnboardResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserOnboardResponse:
        """Test UserOnboardResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserOnboardResponse`
        """
        model = UserOnboardResponse()
        if include_optional:
    ...
    def testUserOnboardResponse(self):
        """Test UserOnboardResponse"""
