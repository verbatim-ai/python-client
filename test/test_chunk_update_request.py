...
class TestChunkUpdateRequest(unittest.TestCase):
    """ChunkUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChunkUpdateRequest:
        """Test ChunkUpdateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChunkUpdateRequest`
        """
        model = ChunkUpdateRequest()
        if include_optional:
    ...
    def testChunkUpdateRequest(self):
        """Test ChunkUpdateRequest"""
