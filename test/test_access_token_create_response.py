...
class TestAccessTokenCreateResponse(unittest.TestCase):
    """AccessTokenCreateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessTokenCreateResponse:
        """Test AccessTokenCreateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessTokenCreateResponse`
        """
        model = AccessTokenCreateResponse()
        if include_optional:
            return AccessTokenCreateResponse(
                token = '',
                created_at = '2026-07-07T10:00:00Z',
                expires_at = '2026-07-07T11:00:00Z',
                scope = [corpus:read, doc:update]
            )
        else:
            return AccessTokenCreateResponse(
        )
    ...
    def testAccessTokenCreateResponse(self):
        """Test AccessTokenCreateResponse"""
