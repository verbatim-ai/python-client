...
class TestDocumentInit(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DocumentInit:
        """Test DocumentInit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentInit`
        """
        model = DocumentInit()
        if include_optional:
            return DocumentInit(
