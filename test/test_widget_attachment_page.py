...
class TestWidgetAttachmentPage(unittest.TestCase):
    """WidgetAttachmentPage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WidgetAttachmentPage:
        """Test WidgetAttachmentPage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WidgetAttachmentPage`
        """
        model = WidgetAttachmentPage()
        if include_optional:
            return WidgetAttachmentPage(
                index = 56,
                preview_small_url = '',
                preview_small_large = ''
            )
    ...
    def testWidgetAttachmentPage(self):
        """Test WidgetAttachmentPage"""
