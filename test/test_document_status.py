...
class TestDocumentStatus(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DocumentStatus:
        """Test DocumentStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentStatus`
        """
        ...
        if include_optional:
            return DocumentStatus(
                ...
                status = 'PROCESSING',
                status_msg = 'Embedding model returned an empty vector',
