...
class TestUsageTokens(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UsageTokens:
        """Test UsageTokens
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsageTokens`
        """
        model = UsageTokens()
        if include_optional:
            return UsageTokens(
