...
class TestWidgetSessionRequestBody(unittest.TestCase):
    """WidgetSessionRequestBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WidgetSessionRequestBody:
        """Test WidgetSessionRequestBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WidgetSessionRequestBody`
        """
        model = WidgetSessionRequestBody()
        if include_optional:
            return WidgetSessionRequestBody(
                text = '',
                session_uuid = ''
            )
        else:
    ...
    def testWidgetSessionRequestBody(self):
        """Test WidgetSessionRequestBody"""
