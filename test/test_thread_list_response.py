...
class TestThreadListResponse(unittest.TestCase):
    """ThreadListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ThreadListResponse:
        """Test ThreadListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThreadListResponse`
        """
        model = ThreadListResponse()
        if include_optional:
            return ThreadListResponse(
                ...
                total = 42,
                items = [
                    verbatim_client.models.thread.Thread(
    ...
    def testThreadListResponse(self):
        """Test ThreadListResponse"""
