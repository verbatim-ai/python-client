...
class TestWidgetQueryResponse(unittest.TestCase):
    """WidgetQueryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WidgetQueryResponse:
        """Test WidgetQueryResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WidgetQueryResponse`
        """
        model = WidgetQueryResponse()
        if include_optional:
    ...
    def testWidgetQueryResponse(self):
        """Test WidgetQueryResponse"""
