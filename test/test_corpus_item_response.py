...
class TestCorpusItemResponse(unittest.TestCase):
    """CorpusItemResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CorpusItemResponse:
        """Test CorpusItemResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CorpusItemResponse`
        """
    ...
    def testCorpusItemResponse(self):
        """Test CorpusItemResponse"""
