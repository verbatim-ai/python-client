...
class TestCorpusUpdateResponse(unittest.TestCase):
    """CorpusUpdateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CorpusUpdateResponse:
        """Test CorpusUpdateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CorpusUpdateResponse`
        """
        model = CorpusUpdateResponse()
        if include_optional:
    ...
    def testCorpusUpdateResponse(self):
        """Test CorpusUpdateResponse"""
