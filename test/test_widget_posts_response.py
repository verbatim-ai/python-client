...
class TestWidgetPostsResponse(unittest.TestCase):
    """WidgetPostsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WidgetPostsResponse:
        """Test WidgetPostsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WidgetPostsResponse`
        """
        model = WidgetPostsResponse()
        if include_optional:
            return WidgetPostsResponse(
                timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                session_id = '',
                items = [
                    verbatim_client.models.widget_post.WidgetPost(
                        id = '', 
                        text = '', 
                        owner = 'USER', 
                        lang = 'fr', 
    ...
    def testWidgetPostsResponse(self):
        """Test WidgetPostsResponse"""
