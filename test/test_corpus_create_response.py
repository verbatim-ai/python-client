...
class TestCorpusCreateResponse(unittest.TestCase):
    """CorpusCreateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CorpusCreateResponse:
        """Test CorpusCreateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CorpusCreateResponse`
        """
        model = CorpusCreateResponse()
        if include_optional:
    ...
    def testCorpusCreateResponse(self):
        """Test CorpusCreateResponse"""
