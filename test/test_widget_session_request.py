...
class TestWidgetSessionRequest(unittest.TestCase):
    """WidgetSessionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WidgetSessionRequest:
        """Test WidgetSessionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WidgetSessionRequest`
        """
        model = WidgetSessionRequest()
        if include_optional:
            return WidgetSessionRequest(
                widget_name = 'Corp. Website',
                display_name = 'Session on BCorp. web site for user Alpha',
                corpus = [
                    ''
                    ]
            )
    ...
    def testWidgetSessionRequest(self):
        """Test WidgetSessionRequest"""
