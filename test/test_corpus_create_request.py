...
class TestCorpusCreateRequest(unittest.TestCase):
    """CorpusCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CorpusCreateRequest:
        """Test CorpusCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CorpusCreateRequest`
        """
        model = CorpusCreateRequest()
        if include_optional:
    ...
    def testCorpusCreateRequest(self):
        """Test CorpusCreateRequest"""
