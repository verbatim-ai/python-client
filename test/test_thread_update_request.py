...
class TestThreadUpdateRequest(unittest.TestCase):
    """ThreadUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ThreadUpdateRequest:
        """Test ThreadUpdateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThreadUpdateRequest`
        """
        model = ThreadUpdateRequest()
        if include_optional:
            return ThreadUpdateRequest(
    ...
    def testThreadUpdateRequest(self):
        """Test ThreadUpdateRequest"""
