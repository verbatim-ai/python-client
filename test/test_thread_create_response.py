...
class TestThreadCreateResponse(unittest.TestCase):
    """ThreadCreateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ThreadCreateResponse:
        """Test ThreadCreateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThreadCreateResponse`
        """
        model = ThreadCreateResponse()
        if include_optional:
    ...
    def testThreadCreateResponse(self):
        """Test ThreadCreateResponse"""
