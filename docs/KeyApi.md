...
with verbatim_client.ApiClient(configuration) as api_client:
    ...
    api_instance = verbatim_client.KeyApi(api_client)
    key_id = UUID('123e4567-e89b-12d3-a456-426614174000') # UUID | ID of the key to activate.

    try:
        # Activate a key
        api_response = api_instance.activate(key_id)
        print("The response of KeyApi->activate:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling KeyApi->activate: %s\n" % e)
```
...
with verbatim_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of KeyApi->deactivate:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling KeyApi->deactivate: %s\n" % e)
```
...
with verbatim_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of KeyApi->delete1:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling KeyApi->delete1: %s\n" % e)
```
...
with verbatim_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of KeyApi->get1:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling KeyApi->get1: %s\n" % e)
```
...
with verbatim_client.ApiClient(configuration) as api_client:
 ...
 # str | 
    ...
    try:
        ...
        print("The response of KeyApi->publish:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling KeyApi->publish: %s\n" % e)
```
...
with verbatim_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of KeyApi->update1:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling KeyApi->update1: %s\n" % e)
```
