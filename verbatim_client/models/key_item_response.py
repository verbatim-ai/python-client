...
class KeyItemResponse(BaseModel):
    ...
    item: Optional[Key] = Field(default=None, description="The key payload (raw RSA content is never returned).")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "orgId": obj.get("orgId"),
            "item": Key.from_dict(obj["item"]) if obj.get("item") is not None else None
        })
        return _obj
