...
class AckResponse(BaseModel):
    ...
    """ # noqa: E501
    timestamp: datetime = Field(description="Creation timestamp (ISO-8601, UTC).", json_schema_extra={"examples": ["2026-04-23T04:06:51Z"]})
    message: StrictStr = Field(description="Message content.", json_schema_extra={"examples": ["Operation acknowledged"]})
