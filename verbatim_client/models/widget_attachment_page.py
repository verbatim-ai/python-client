...
class WidgetAttachmentPage(BaseModel):
    """
    WidgetAttachmentPage
    """ # noqa: E501
    index: StrictInt = Field(description="Index of the page (1-based)")
    preview_small_url: Optional[StrictStr] = Field(default=None, alias="previewSmallUrl")
    preview_small_large: Optional[StrictStr] = Field(default=None, alias="previewSmallLarge")
    __properties: ClassVar[List[str]] = ["index", "previewSmallUrl", "previewSmallLarge"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "index": obj.get("index"),
            "previewSmallUrl": obj.get("previewSmallUrl"),
            "previewSmallLarge": obj.get("previewSmallLarge")
        })
        return _obj
