...
class DocumentSearchResponse(BaseModel):
    ...
    items: List[Document] = Field(description="Documents contained in this page, in the requested sort order.")
    __properties: ClassVar[List[str]] = ["corpusId", "pageIndex", "pageSize", "total", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pageIndex": obj.get("pageIndex") if obj.get("pageIndex") is not None else 0,
