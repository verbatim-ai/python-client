...
class WidgetAttachment(BaseModel):
    """
    WidgetAttachment
    """ # noqa: E501
    ...
    pages: List[WidgetAttachmentPage] = Field(description="Sorted list of page (1-based) retrieved from this document with preview image url.")
    ...
    preview_expiration_date: Optional[datetime] = Field(default=None, alias="previewExpirationDate")
    __properties: ClassVar[List[str]] = ["docId", "summary", "pages", "metadata", "previewExpirationDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pages": [WidgetAttachmentPage.from_dict(_item) for _item in obj["pages"]] if obj.get("pages") is not None else None,
            "metadata": obj.get("metadata"),
            "previewExpirationDate": obj.get("previewExpirationDate")
        })
        return _obj
