...
class WidgetSessionResponse(BaseModel):
    ...
    """ # noqa: E501
    timestamp: Optional[datetime] = Field(default=None, description="Timestamp when the session was created")
    session_id: Optional[UUID] = Field(default=None, description="Id of the session", alias="sessionId")
    display_name: Optional[StrictStr] = Field(default=None, description="Display name of the session (session history in the backoffice", alias="displayName")
    widget_name: Optional[StrictStr] = Field(default=None, description="Name of the widget of init the session", alias="widgetName")
    corpus: Optional[List[UUID]] = Field(default=None, description="a list of corpus attach to the session")
    __properties: ClassVar[List[str]] = ["timestamp", "sessionId", "displayName", "widgetName", "corpus"]
