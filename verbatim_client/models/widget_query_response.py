...
class WidgetQueryResponse(BaseModel):
    ...
    WidgetQueryResponse
    """ # noqa: E501
    timestamp: Optional[datetime] = Field(default=None, description="Timestamp when the answer was generated")
    session_id: Optional[UUID] = Field(default=None, description="Id of the session the query belongs to", alias="sessionId")
    query: Optional[StrictStr] = Field(default=None, description="The user query that was submitted")
    body: Optional[StrictStr] = Field(default=None, description="The AI-generated answer, may include markdown and source citations")
    attachment: Optional[StrictInt] = Field(default=None, description="Number of source document chunks cited in the answer")
    __properties: ClassVar[List[str]] = ["timestamp", "sessionId", "query", "body", "attachment"]
