...
class ThreadListResponse(BaseModel):
    ...
    items: Optional[List[Thread]] = Field(default=None, description="Threads contained in this page, newest first.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "items": [Thread.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
