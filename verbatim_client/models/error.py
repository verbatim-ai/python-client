...
class Error(BaseModel):
    ...
    """ # noqa: E501
    timestamp: Optional[datetime] = Field(default=None, description="Server-side timestamp the error was produced (ISO-8601, UTC).", json_schema_extra={"examples": ["2026-04-23T04:06:51Z"]})
    status: Optional[StrictInt] = Field(default=None, description="HTTP status code returned to the client.", json_schema_extra={"examples": [500]})
    error: Optional[StrictStr] = Field(default=None, description="HTTP status reason phrase.", json_schema_extra={"examples": ["Internal Server Error"]})
    message: Optional[StrictStr] = Field(default=None, description="Human-readable error message — safe to surface to API consumers.", json_schema_extra={"examples": ["corpus not found"]})
    path: Optional[StrictStr] = Field(default=None, description="Servlet path of the request that produced the error.", json_schema_extra={"examples": ["/v1/corpus/id"]})
