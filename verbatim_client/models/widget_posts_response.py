...
class WidgetPostsResponse(BaseModel):
    """
    WidgetPostsResponse
    """ # noqa: E501
    ...
    items: Optional[List[WidgetPost]] = Field(default=None, description="Chronological list of all posts in the session (user queries and AI answers interleaved)")
    __properties: ClassVar[List[str]] = ["timestamp", "sessionId", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [WidgetPost.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
