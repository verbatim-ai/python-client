...
class WidgetAttachmentResponse(BaseModel):
    """
    ...
    post_id: Optional[UUID] = Field(default=None, description="Id of the post related to the context", alias="postId")
    items: Optional[List[WidgetAttachment]] = Field(default=None, description="Attachments of the post")
    __properties: ClassVar[List[str]] = ["timestamp", "postId", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [WidgetAttachment.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
