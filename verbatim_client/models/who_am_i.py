...
class WhoAmI(BaseModel):
    ...
    timestamp: Optional[datetime] = Field(default=None, description="Reference timestamp the metadata were computed at (ISO-8601, UTC).", json_schema_extra={"examples": ["2026-04-23T04:06:51Z"]})
