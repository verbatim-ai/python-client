...
class KeyUpdateRequest(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="New name of the key. Omit to keep the current name.", json_schema_extra={"examples": ["support-backend-prod"]})
    description: Optional[StrictStr] = Field(default=None, description="New description of the key. Omit to keep the current description.", json_schema_extra={"examples": ["Production signing key for the support backend."]})
