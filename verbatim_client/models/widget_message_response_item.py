...
class WidgetMessageResponseItem(BaseModel):
    """
    WidgetMessageResponseItem
    """ # noqa: E501
    input: Optional[WidgetSessionRequestBody] = None
    output: Optional[WidgetSessionRequestBody] = None
    session_uuid: Optional[StrictStr] = Field(default=None, alias="sessionUuid")
    __properties: ClassVar[List[str]] = ["input", "output", "sessionUuid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "input": WidgetSessionRequestBody.from_dict(obj["input"]) if obj.get("input") is not None else None,
            "output": WidgetSessionRequestBody.from_dict(obj["output"]) if obj.get("output") is not None else None,
