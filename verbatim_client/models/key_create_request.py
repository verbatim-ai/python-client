...
class KeyCreateRequest(BaseModel):
    ...
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Human-readable name of the key.", json_schema_extra={"examples": ["support-backend-prod"]})
    description: Optional[StrictStr] = Field(default=None, description="Free-form description of the key.", json_schema_extra={"examples": ["Production signing key for the support backend."]})
