...
from verbatim_client.configuration import Configuration
from verbatim_client.api_response import ApiResponse, T as ApiResponseT
import verbatim_client.models
from verbatim_client import rest
from verbatim_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(verbatim_client.models, klass)
